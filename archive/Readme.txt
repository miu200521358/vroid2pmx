...
　VRoid Studio 1.0.xx でエクスポートされたVrmデータをPmxデータに変換します。
　
...
　PmxTailorの「Vroid2Pmx設定インポート」ボタンで設定が簡単に導入できます。
...
----------------------------------------------------------------
 ...
 4. リップモーフは、グループモーフ0.7倍でとりあえず登録しています。
    VRoid Studio等で作成したモーフ等倍で使用したい場合、該当グループモーフの倍率を「1」に変更してください。
